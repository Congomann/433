    ...
    const renderView = () => {
        ...
        try {
            switch (view) {
                ...
                case 'underwriting-portal': return <UnderwritingPortal policies={db.policies} clients={db.clients} agents={db.agents} onNavigate={handleNavigate} onReviewPolicy={handleOpenReviewModal} />;
